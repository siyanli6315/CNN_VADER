...
model1=Sequential()
model1.add(Embedding(input_dim=len(vocabulary),output_dim=20,input_length=56))
model1.add(Dropout(0.25,input_shape=(56,20)))
model1.add(graph)
...
model1.add(Activation("relu"))
model2=Sequential()
model2.add(Dropout(0.25,input_shape=(4,)))
...
model.fit([x_shuffled,vader_shuffled], y_shuffled, batch_size=32,nb_epoch=50,shuffle=True,validation_split=0.1,verbose=2)
